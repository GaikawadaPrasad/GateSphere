...
## Purpose
Security-guard live dashboard: entry/exit processing, pass verification, attendance stamping, panic alerts.
...
## API
Base path: `/api/v1/gate`. Contract: [`docs/backend/api/gate.md`](../../api/gate.md); OpenAPI at `/docs`.

## Events
- Emails / notifications: _list_
- Background jobs (Celery): `app/modules/gate/tasks.py`
- Audit events: _list_
