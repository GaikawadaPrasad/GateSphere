...
## Purpose
Visitor lifecycle: gate entry -> resident approval -> entry/exit stamps -> audit. Pre-approvals, OTP/QR passes, blacklist screening.
...
## API
Base path: `/api/v1/visitors`. Contract: [`docs/backend/api/visitors.md`](../../api/visitors.md); OpenAPI at `/docs`.

## Events
- Emails / notifications: _list_
- Background jobs (Celery): `app/modules/visitors/tasks.py`
- Audit events: _list_
