...
## Purpose
Push/SMS/WhatsApp/email dispatch abstraction with provider mocks; templated events.
...
## API
Base path: `/api/v1/notifications`. Contract: [`docs/backend/api/notifications.md`](../../api/notifications.md); OpenAPI at `/docs`.

## Events
- Emails / notifications: _list_
- Background jobs (Celery): `app/modules/notifications/tasks.py`
- Audit events: _list_
