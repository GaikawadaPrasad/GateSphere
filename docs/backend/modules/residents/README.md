...
## Purpose
Owner/tenant/family-member profiles, emergency contacts, move-in/move-out clearances.
...
## API
Base path: `/api/v1/residents`. Contract: [`docs/backend/api/residents.md`](../../api/residents.md); OpenAPI at `/docs`.

## Events
- Emails / notifications: _list_
- Background jobs (Celery): `app/modules/residents/tasks.py`
- Audit events: _list_
