...
| association_committee | `billing:view/create/approve/export` (create = propose assessment; self-approval blocked by maker-checker), `incidents:view`, `dashboards:view`, `audit:view` |
