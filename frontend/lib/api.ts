...
export function getActiveRole(): string | null {
  if (typeof window !== "undefined") {
    ...
    if (pathname.startsWith("/security-guard") || pathname.startsWith("/dashboard/security-guard"))
...
export const billingApi = {
  ...
  exportInvoicesCsv: (
    params?: string | Record<string, unknown> | { community_id?: string; invoice_status?: string },
  ) =>
    apiGet<string>(
