    ...
    <div className="card" style={{ height: "100%", display: "flex", flexDirection: "column" }}>
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.5rem" }}>
          ...
          <span style={{ fontSize: "0.95rem", fontWeight: 700, color: collectionRate >= 80 ? "#059669" : "#d97706" }}>
            {collectionRate}%
          </span>
        </div>
        ...
        <div style={{ width: "100%", height: 10, background: "#e2e8f0", borderRadius: 999, overflow: "hidden" }}>
          <div
            style={{
              ...
              height: "100%",
              background: collectionRate >= 80 ? "linear-gradient(90deg, #10b981, #059669)" : "linear-gradient(90deg, #f59e0b, #d97706)",
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "0.75rem", marginTop: "1rem" }}>
          <div>
            <div style={{ fontSize: "0.725rem", color: "var(--muted)", textTransform: "uppercase" }}>Total Invoiced</div>
            <div style={{ fontSize: "1.1rem", fontWeight: 700, color: "var(--fg)" }}>{formatCurrency(billed)}</div>
          </div>
          <div>
            <div style={{ fontSize: "0.725rem", color: "var(--muted)", textTransform: "uppercase" }}>Total Collected</div>
            <div style={{ fontSize: "1.1rem", fontWeight: 700, color: "#059669" }}>{formatCurrency(collected)}</div>
          </div>
          <div>
            <div style={{ fontSize: "0.725rem", color: "var(--muted)", textTransform: "uppercase" }}>Outstanding Dues</div>
            <div style={{ fontSize: "1.1rem", fontWeight: 700, color: outstanding > 0 ? "#dc2626" : "var(--fg)" }}>
      ...
      <div style={{ flex: 1 }}>
        <h3 style={{ fontSize: "0.85rem", fontWeight: 600, color: "var(--fg-secondary)", marginBottom: "0.5rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "0.5rem" }}>
          ...
          >
            <span style={{ fontSize: "0.8rem", color: "var(--fg-secondary)" }}>Overdue Invoices</span>
          ...
          >
            <span style={{ fontSize: "0.8rem", color: "var(--fg-secondary)" }}>Posted / Pending</span>
