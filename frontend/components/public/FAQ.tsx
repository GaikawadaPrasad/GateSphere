      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          <div className={`lg:col-span-5 reveal-left ${visible ? "visible" : ""} space-y-6 lg:sticky lg:top-24`}>
            ...
            <div className="p-5 rounded-2xl border border-slate-200/90 bg-[#F8FAFC] shadow-sm relative overflow-hidden">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h3 className="text-[14px] font-bold text-slate-900" style={{ fontFamily: "'Outfit', sans-serif" }}>
                    Have a specific question?
                  </h3>
                  <div className="flex items-center gap-1.5 text-[11.5px] text-emerald-600 font-semibold">
              ...
              <p className="text-[12.5px] text-slate-600 leading-relaxed mb-4">
                Our community operations team is ready to provide custom architecture answers for your township.
              </p>

              <Link
                href="/demo"
                className="w-full inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-[13px] font-bold text-blue-700 bg-white border border-blue-200 hover:bg-blue-50 hover:border-blue-300 transition-all shadow-xs"
              >
