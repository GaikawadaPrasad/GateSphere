...
export default function CommunityAdminDashboardPage() {
  ...
  const occupancyRate =
    totalUnits > 0 ? Math.min(100, Math.round((totalResidents / totalUnits) * 100)) : 0;
  ...
  const staffAttendanceRate =
    totalStaff > 0 ? Math.min(100, Math.round((staffPresentToday / totalStaff) * 100)) : 0;
      ...
      >
        ...
        <KpiCard
          ...
          badge={{
            ...
            variant: occupancyRate >= 50 ? "success" : "neutral",
          }}
          ...
          >
            ...
            {movesLoading ? (
              ...
              >
                ...
                <div style={{ fontSize: "0.75rem", color: "#b45309", marginTop: "0.35rem" }}>
                  New resident move-in/out records awaiting administrative approval and gate pass
                  clearance.
                </div>
              </div>
            ) : (
            ...
            <div>
              ...
              {announcementsLoading ? (
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                  {sortedAnnouncements.slice(0, 3).map((a: any) => (
                    <div
                      key={a.id}
                      style={{
