...
export function OwnerTenantDashboardView({
  ...
  const bookedParticipantCount = (amenities.bookings.data || [])
    .filter(
      (b) =>
        b.amenity_id === selectedAmenity?.id && b.date === bookingDate && b.status !== "cancelled",
    )
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: "0.6rem" }}>
                        ...
                        <div>
                          <strong
                            style={{
                              fontSize: "13.5px",
                              color: isFull ? "var(--brand-muted)" : "var(--brand-heading)",
                            }}
                          >
                          ...
                          {s.fee && Number(s.fee) > 0 && (
                            <span
                              style={{ fontSize: "12px", color: "#2563EB", marginLeft: "0.5rem" }}
                            >
                              (${s.fee})
                            </span>
                          )}
